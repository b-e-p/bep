...
class Language(object):
    ...
    def execute_shell_cmd(self, cmd):
        ...
        try:
            ...
            print("\nError: Cannot use {} to install packages".format(self.lang_arg))
            raise SystemExit
...
class Python(Language):
    ...
    def get_lang_cmd(self, lang_arg):
        ...
        #get_version_cmd = "{} -c 'import sys; print(sys.version[0:3])'".format(self.system_default)
        version = self.execute_shell_cmd(get_version_cmd)
